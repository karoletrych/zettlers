...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        public float keyboardMovementSpeed = 30f; //speed with keyboard movement
        public float screenEdgeMovementSpeed = 30f; //spee with screen edge movement
        ...
        public float minHeight = 1f; //maximal height
